...
For this purpose, you should define a common logic that you don’t need to duplicate in all platform modules – 
you can just add it once to the common module. However, the actual implementation of the WebSocket class differs
