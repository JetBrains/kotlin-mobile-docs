...
* [New compatibility policy: for each feature release of Kotlin there will be a new release of the KMM plugin](https://youtrack.jetbrains.com/issue/KT-43211).
...
* [Test status icon displayed in the gutter for multiplatform projects](https://youtrack.jetbrains.com/issue/KT-34504). (TODO Lilya suggests removing this because it was FAR TIME AGO)
* [A new error now notifies users that they can only launch iOS applications on macOS](https://youtrack.jetbrains.com/issue/KT-43442). (TODO TBD remove this item? Katya, Lilya and Ilya +1)
